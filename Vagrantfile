...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  machines = [
    ...
    { name: "prometheus", box: "prometheus-6.5.14-201602120407", box_url: '"https://s3-us-west-1.amazonaws.com/com.altiscale.vagrant/prometheus/boxes/prometheus-6.5.14-201602120407.box?AWSAccessKeyId=AKIAIKOVEEW6FVT5JBQA&Expires=1770868554&Signature=YIhNZGY0VRD%2Bs9Z8PopwRgrvBbA%3D"' }
  ]
